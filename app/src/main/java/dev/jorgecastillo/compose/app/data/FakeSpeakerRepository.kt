...
class FakeSpeakerRepository {
    ...
    fun getSpeakers(): List<Speaker> = listOf(
        ...
        Speaker("36", "Lindiwe Nosipho", "Twitter"),
        Speaker("37", "Funmilayo Oluwaseun", "Uber"),
        Speaker("38", "Yejide Bose", "Meta"),
        Speaker("39", "Efua Ola", "Lyft"),
        Speaker("40", "Tiwonge Olusola", "Blinkist"),
